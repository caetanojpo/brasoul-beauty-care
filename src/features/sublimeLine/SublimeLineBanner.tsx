...
export const SublimeLineBanner = () => {
    ...
    return (
        <Container id="inicio">
                    ...
                    <Flex flexDir="column" px="30px" mb="30px">
                        ...
                        >
                            {language === 'en'
                                ...
                                : language === 'br' ? `A LINHA SUBLIME FOI CUIDADOSAMENTE DESENVOLVIDA COM UM PODEROSO
            ...
            PROTEÍNAS VEGETAIS.` : 'LA LÍNEA SUBLIME FUE CUIDADOSAMENTE DESARROLLADA CON UNA PODEROSA MEZCLA DE AMINOÁCIDOS, ACTUANDO EN LA REPOSICIÓN DE LA CAPA LIPÍDICA DEL CABELLO SIN DAÑAR LAS HEBRAS, YA QUE SU FÓRMULA ESTÁ ENRIQUECIDA CON ARGININA, CREATINA, SERINA, CISTEÍNA, COLÁGENO, ÁCIDO HIALURÓNICO, PANTENOL Y MANTECA DE KARITÉ, ADEMÁS DE UNA PODEROSA MEZCLA DE PROTEÍNAS VEGETALES.'}
                        </Text>
                    </Flex>
                    <Link
