...
export default function Footer() {
  ...
  const footerNavigation = [
    { title: language ? "ABOUT BRASOUL" : `SOBRE A BRASOUL`, link: `#about` },
    { title: language ? "CONTACT" : `CONTATO`, link: `#contact` },
    { title: language ? "HOW TO BUY" : `COMO COMPRAR`, link: `#buy` },
    ...
    <Flex h="100%" w="100%" flexDirection={"column"}>
      ...
      >
        ...
        >
          ...
          />{" "}
          <Input
            placeholder={language ? "YOUR EMAIL" : "SEU EMAIL"}
            variant="unstyled"
            border="2px solid"
            name="email"
            className="border"
      ...
      >
        ...
        <Flex flexDir={"column"} gap="1.5rem">
          <GradientText as="h2" title={language ? "CONTACT" : "CONTATO"} />
          <List
            display={"flex"}
            flexDirection={"column"}
            gap="1.5rem"
