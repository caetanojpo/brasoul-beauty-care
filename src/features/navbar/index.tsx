...
export const Navbar = () => {
  ...
  const navLinks: TNavLinks[] = [
    { title: language ? "Home" : "Início", link: "#inicio", divider: true },
    { title: language ? "About us" : "Sobre", link: "#about", divider: true },
    {
      title: language ? "Products" : "Linhas",
      link: "#products",
      divider: true,
    },
    {
      title: language ? "Contact" : "Contato",
      link: "#contact",
      divider: false,
    },
  ];
    ...
    <Container position={"fixed"} zIndex="900">
      ...
      >
        <Flex h="100%" w="20%" justify="space-evenly" align="center" ml={{base:'0rem', lg:'0px'}}>
          <Flex display={{base:'flex', lg:'flex'}} h="80%" align="center" justify="center" position="relative">
            <Image
              width={40}
              src={fingerPrint}
        ...
        >
          ...
          >
            ...
            <ListItem w="5%">
              ...
              >
                <input type="checkbox" className="checkbox" checked={language ? true : false} onChange={() => ''}/>
